...
package app.com.tweentydegreespractical.ui.details
...
import app.com.tweentydegreespractical.databinding.ActivityPostDetailsBinding
...
class PostDetailsActivity : BaseActivity<PostDetailsViewModel, ActivityPostDetailsBinding>() {
    ...
    private fun initPost() {
        mViewModel.post.observe(this) { post ->
            ...
            mViewBinding.imageView.load(post.urlToImage)
        }
    }
